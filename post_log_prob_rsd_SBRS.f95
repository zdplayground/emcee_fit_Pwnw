!
! Use f2py -m post_lnprob_module_rsd_SBRS -h post_lnprob_module_rsd_SBRS.pyf post_log_prob_rsd_SBRS.f95 --overwrite-signature to generate
! signature file.
! Use f2py -c --fcompiler=gnu95 post_lnprob_module_rsd_SBRS.pyf post_log_prob_rsd_SBRS.f95 to generate the module
!
